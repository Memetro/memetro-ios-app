...
@property (nonatomic, strong) UIColor *CancelColor NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR;
...
- (void)setCancelImage:(UIImage *)CancelImage forState:(UIControlState)state NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR;
